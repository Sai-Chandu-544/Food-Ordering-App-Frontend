    ...
    <>
      ...
      {menuOpen && (
        ...
        >
          ...
          <div
            className="bg-white shadow-2xl pt-20 pl-10 w-full rounded-b-2xl space-y-6"
            ...
            {isSignedIn ? (
              <>
                <ul className="flex flex-col gap-3 text-gray-800 font-medium">
                  ...
                  <li>
                    <NavLink to="/user/orders" onClick={() => setMenuOpen(false)}>
                      Orders
                    </NavLink>
                  </li>
                ...
                <button
                  ...
                  className="w-full mt-4 py-2 rounded-lg bg-red-50 text-red-600 font-semibold hover:bg-red-100"
                >
                  Logout
                </button>
              ...
              <div className="flex flex-col gap-3">
                ...
                <NavLink
                  to="/user/register"
                  onClick={() => setMenuOpen(false)}
                  className="w-full text-center py-2 rounded-lg border border-orange-400 text-orange-500"
                >
                  Register
                </NavLink>
